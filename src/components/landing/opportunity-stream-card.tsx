    ...
    <TooltipProvider delayDuration={200}>
      ...
      >
        <button
          ...
          className="group flex w-full items-center gap-4 px-6 py-5 text-left focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-brand-600"
        >
          <span
            className={cn(
