...
export function LostToInactionCard({ data }: LostToInactionCardProps) {
  return (
    <Card
      className={cn(
        "relative flex w-full shrink-0 overflow-hidden rounded-2xl border-red-50 bg-surface shadow-sm lg:w-70",
    ...
    >
      <CardContent className="relative z-10 flex flex-1 flex-col justify-between gap-6 bg-transparent p-0">
        <div className="px-5 pt-5">
          <span className="inline-flex items-center rounded-full border border-error-200 bg-error-100 px-2.5 py-0.5 type-caption-strong text-feedback-danger">
            Lost to inaction
          </span>
