...
export const q3Overview: OverviewSnapshot = {
  ...
  calculation: {
    annualized: {
      ...
      liftBarPct: { retailReadiness: 4, amazonOptimization: 21, seasonal: 75 },
      kpis: [
      ...
      methodology:
        "Q3 revenue comes from Vendor Central history for Jul 1 – Sep 30. $2.33M × 3.0% = $0.07M. $11.34M × 3.0% = $0.34M. $41.33M × 3.0% = $1.24M. Together that is $1.65M. Prime Day's missed $890K is excluded.",
    },
    valueRealized: {
      id: "value-realized",
      ...
      buckets: [
        {
          ...
          skuCount: 35,
          fillMode: "input",
          fillTime: "~1 min each · 3 need your input",
          valueThousands: 48,
